...
from fabworks.utils import unique_slug_generator
...
def get_filename_ext(filepath):
    ...
    return name, ext
# ------------------ create new filename with no saces----------------- 
def upload_image_path(instance, filename):
    print(instance)
    print(filename)
    new_filename = random.randint(1,346789944)
...
class Product(models.Model):
    ...
    catagory        = models.CharField(max_length=120, default="misc")
